...
from transportation.utils import loc2bbox, nms, DecodeBox
from transportation.nets.frcnn import FasterRCNN
from transportation.nets.frcnn_training import get_new_img_size
...
class FRCNN(object):
    _defaults = {
        "model_path": 'E:/pycharm/car/transportation/Epoch50-Total_Loss0.1486-Val_Loss0.1510.pth',
        "classes_path": 'E:/pycharm/car/transportation/model_data/classes.txt',
        "confidence": 0.5,
        "backbone": "resnet50"
    }
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='E:/pycharm/car/transportation/model_data/simhei.ttf',
